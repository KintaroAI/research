...
def create_weight_matrix_deprecated(neurons_count):
...
def create_weight_matrix(neurons_count, width, height):
...
weight_matrix = create_weight_matrix(neurons_count, columns, rows)
print(weight_matrix)

for _ in range(100):
    greedy_swap(neurons_matrix, weight_matrix)
print(neurons_matrix)
