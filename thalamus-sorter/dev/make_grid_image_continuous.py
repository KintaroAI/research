...
Top-left cell: original image. Top row: K labels. Left column: LR labels.
...
os.makedirs("output_grid_continuous", exist_ok=True)
...
for frame_idx in range(n_frames):
    ...
    # Left column: LR labels
    for ri, lr in enumerate(learning_rates):
    ...
    out_path = os.path.join("output_grid_continuous", f"grid_{frame_idx:06d}.png")
